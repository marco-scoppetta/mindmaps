...
import io.mindmaps.postprocessing.BackgroundTasksManager;
...
public class QueueManager {
    ...
    private QueueManager() {
        ...
        MAINTENANCE_ITERATION = Integer.parseInt(prop.getProperty("backgroundTasks.maintenance-iteration"));
        NUM_THREADS = Integer.parseInt(prop.getProperty("loader.threads"));
